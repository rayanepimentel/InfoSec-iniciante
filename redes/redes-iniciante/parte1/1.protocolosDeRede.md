...
Protocolo de Transferência de Hipertexto(HTTP) é um protocolo usado dentro do modelo
Client/Server é baseado em pedidos (requests) e respostas (responses).

Ele é a forma em que o Cliente e o Servidor se comunicam.
Pensando em uniformizar a comunicação entre servidores e clientes foram criados
códigos e verbos que são usados por ambas as partes, e essas requisições são feitas em
URLs que possuem uma estrutura específica.
...
- E no campo de busca você pesquisou por "Livros". Apareceu uma lista com todos os livros do site.
Ao fazer isso, geralmente usamos o **GET**.
...
Fonte: [Reprograma](https://github.com/reprograma/ON15-TET-S8-API-I/blob/main/material/API%20GET.pdf)

Quer se aprofundar mais? aqui tem uma explicação muito boa sobre [O que é HTTP, como funciona e qual a sua diferença para HTTP 2](https://igluonline.com/o-que-e-http-como-funciona-e-qual-a-sua-diferenca-para-http-2/) do André Lug.
...
![HTTP e HTTPS](../pics/httpehttps.png)
...
[< Anterior](https://rayanepimentel.github.io/InfoSec-iniciante/redes/redes-iniciante/parte1/menu.html) | [Próxima >](https://rayanepimentel.github.io/InfoSec-iniciante/redes/redes-iniciante/parte1/2.modelosOSI.html)