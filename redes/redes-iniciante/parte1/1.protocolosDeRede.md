...
<aside>
💡
Os agentes de ameaças usam pacotes de eco (pings) do protocolo de mensagens de controle da Internet (ICMP) para descobrir sub-redes e hosts em uma rede protegida, para gerar ataques de inundação DoS e para alterar as tabelas de roteamento de host.
</aside>
...
Mais ataques: [CNNA-Network](https://ccna.network/vulnerabilidades-ameacas-ip/), [UFRJ](https://www.gta.ufrj.br/grad/13_1/dos/ataques.html)
